import{t as g,e as S,m as N,u as W,E as Y,v as x,w as L,x as O,y as k,L as q,i as E,C,r as _,z as D,F as H}from"./index.esm.DLs28QBg.js";import"./index.esm.DDFK2_G6.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(t){this.app=t}_delete(){return delete u[this.app.options.appId],Promise.resolve()}}let u={},P=[];const M={};let w="dataLayer",K="gtag",R,p,T=!1;function Le(e){if(T)throw d.create("already-initialized");e.dataLayerName&&(w=e.dataLayerName),e.gtagName&&(K=e.gtagName)}function De(){const e=[];if(x()&&e.push("This is a browser extension environment."),L()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,i)=>`(${i+1}) ${a}`).join(" "),n=d.create("invalid-analytics-context",{errorInfo:t});l.warn(n.message)}}function Pe(e,t,n){De();const a=e.options.appId;if(!a)throw d.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)l.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw d.create("no-api-key");if(u[a]!=null)throw d.create("already-exists",{id:a});if(!T){ie(w);const{wrappedGtag:s,gtagCore:o}=oe(u,P,M,w,K);p=s,R=o,T=!0}return u[a]=Ce(e,P,M,t,R,w,n),new _e(e)}function Oe(e=N()){e=g(e);const t=S(e,I);return t.isInitialized()?t.getImmediate():Me(e)}function Me(e,t={}){const n=S(e,I);if(n.isInitialized()){const i=n.getImmediate();if(W(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}async function ke(){if(x()||!L()||!O())return!1;try{return await k()}catch{return!1}}function ze(e,t,n){e=g(e),Ie(p,u[e.app.options.appId],t,n).catch(a=>l.error(a))}async function Ge(e){return e=g(e),Te(p,u[e.app.options.appId])}function Ue(e,t,n){e=g(e),be(p,u[e.app.options.appId],t,n).catch(a=>l.error(a))}function Re(e,t,n){e=g(e),ve(p,u[e.app.options.appId],t,n).catch(a=>l.error(a))}function Be(e,t){e=g(e),Ae(u[e.app.options.appId],t).catch(n=>l.error(n))}function je(e){p?p("set",e):j(e)}function Fe(e,t,n,a){e=g(e),we(p,u[e.app.options.appId],t,n,a).catch(i=>l.error(i))}function Ke(e){p?p("consent","update",e):B(e)}const F="@firebase/analytics",$="0.10.22";function $e(){E(new C(I,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),i=t.getProvider("installations-internal").getImmediate();return Pe(a,i,n)},"PUBLIC")),E(new C("analytics-internal",e,"PRIVATE")),_(F,$),_(F,$,"esm2020");function e(t){try{const n=t.getProvider(I).getImmediate();return{logEvent:(a,i,s)=>Fe(n,a,i,s),setUserProperties:(a,i)=>Re(n,a,i)}}catch(n){throw d.create("interop-component-reg-failed",{reason:n})}}}$e();export{Oe as getAnalytics,Ge as getGoogleAnalyticsClientId,Me as initializeAnalytics,ke as isSupported,Fe as logEvent,Be as setAnalyticsCollectionEnabled,Ke as setConsent,ze as setCurrentScreen,je as setDefaultEventParameters,Ue as setUserId,Re as setUserProperties,Le as settings};
